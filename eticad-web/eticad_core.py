...
LETTER_SPACING_FACTOR = 0.1  # harfler arası boşluk oranı


# =========================
# UYGULAMA DİZİNİ / GLYPH YÜKLEME
# =========================
...
def load_glyphs():
    """
    1) Önce programın bulunduğu klasörde glyph_kutuphane.py var mı diye bakar.
    2) Varsa ordaki GLYPHS'i yükler (güncel harf kütüphanesi).
    3) Yoksa hata verir.
    """
    ...
    # Eğer gömülü kullanmak istersen, buraya:
    # from glyph_kutuphane import GLYPHS as bundled
    # return bundled
...
def build_single_dxf(width_mm, height_mm, seg1, seg2, hole_mode):
    """
    DXF içeriğini string olarak döner (dosyaya yazmaz).
    """
    lines = []
...
# Gerekirse multi-etiket için benzer mantıkta build_multi_dxf() yazılabilir.
